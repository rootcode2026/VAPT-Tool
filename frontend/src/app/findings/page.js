...
export default function FindingsPage() {
  ...
  function getSeverityClasses(value) {
    switch (
      ...
      case "critical":
        return "border border-red-700 bg-red-950/70 text-red-400";

      case "high":
        return "border border-orange-700 bg-orange-950/70 text-orange-400";

      case "medium":
        return "border border-yellow-700 bg-yellow-950/70 text-yellow-400";

      case "low":
        return "border border-blue-700 bg-blue-950/70 text-blue-400";
