...
export function IconProjects(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M4 7.5A2.5 2.5 0 0 1 6.5 5H9l1.5 2H17.5A2.5 2.5 0 0 1 20 9.5v7A2.5 2.5 0 0 1 17.5 19h-11A2.5 2.5 0 0 1 4 16.5v-9Z"
        stroke="currentColor"
        strokeWidth="1.6"
      />
    </svg>
...
export function IconScans(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
...
export function IconFindings(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
...
export function IconAttackSurface(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.6" />
      <circle cx="12" cy="12" r="7.25" stroke="currentColor" strokeWidth="1.6" />
      <path d="M12 4.75v2.5M12 16.75v2.5M4.75 12h2.5M16.75 12h2.5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    </svg>
  );
}
...
export function IconSettings(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <circle cx="12" cy="12" r="3" stroke="currentColor" strokeWidth="1.6" />
      <path
        d="M19.4 13.5a7.7 7.7 0 0 0 0-3l1.7-1.3-1.6-2.8-2 .6a7.8 7.8 0 0 0-2.6-1.5L14.5 3h-5l-.4 2.5a7.8 7.8 0 0 0-2.6 1.5l-2-.6L3.9 9.2 5.6 10.5a7.7 7.7 0 0 0 0 3L3.9 14.8l1.6 2.8 2-.6a7.8 7.8 0 0 0 2.6 1.5l.4 2.5h5l.4-2.5a7.8 7.8 0 0 0 2.6-1.5l2 .6 1.6-2.8-1.7-1.3Z"
        stroke="currentColor"
        strokeWidth="1.4"
        strokeLinejoin="round"
      />
...
export function IconBell(props) {
  return (
    <svg viewBox="0 0 24 24" fill="none" aria-hidden="true" {...props}>
      <path
        d="M6 16h12l-1.2-2.2a6.5 6.5 0 0 1-.8-3.1V9.4A5 5 0 0 0 12 4.5 5 5 0 0 0 8 9.4v1.3c0 1.1-.27 2.17-.8 3.1L6 16Z"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinejoin="round"
      />
      <path d="M9.5 16a2.5 2.5 0 0 0 5 0" stroke="currentColor" strokeWidth="1.6" />
    </svg>
  );
}
