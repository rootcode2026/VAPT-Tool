...
from app.api.routes.project_dashboard import router as project_dashboard_router
from app.api.routes.project_compliance import router as project_compliance_router
