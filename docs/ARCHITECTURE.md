...
- **Future wiring:** Audit retention, RLS, etc. remain **DEFERRED** (Phase 6G+). and other remains **DEFERRED** (Phase 6F+)., request/correlation ID middleware, audit read API/UI remain **DEFERRED** (Phase 6E+).
