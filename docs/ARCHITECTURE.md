...
- **Future wiring:** Target, scan, ingestion, cloud, auth routes and background Celery tasks remain **DEFERRED** (Phase 6C+). Read API and request/correlation ID middleware are **DEFERRED**.
