...
- **Future:** Request/correlation ID middleware, audit read API, remaining events (auth/authz-denied), retention (Phase 6E+). `SCAN_CANCELLED` exists but not wired — no cancellation implementation found.
