...
- **Future:** Request/correlation ID middleware, audit read API, remaining events (finding/ingestion/cloud/auth), retention (Phase 6D+). `SCAN_CANCELLED` exists but not wired — no cancellation implementation found.
